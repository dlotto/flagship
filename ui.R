...
ui <- dashboardPage(title = "Flagship",
                    header = dashboardHeader(titleWidth = 210, title = tags$a(id="ichooseyou", href = "", class = "action-button shiny-bound-input", tags$img(src='logo.png', width='160', height='38')),
                                             dropdownMenu(
                                               ...
                                               badgeStatus = NULL,
                                               notificationItem(
                                                 text = "The YouTube icon leads to the Coding Train!",
            ...
            $(document).ready(function() {
              $("header").find("nav").append(\'<span class="links">'
                                      ,'<a href="https://www.youtube.com/channel/UCvjgXvBlbQiydffZU7m1_aw" target="_blank>"','<i class="fab fa-youtube"></i></a>'
                                      ,'<a href="https://www.instagram.com/dantheftotto/" target="_blank>"','<i class="fab fa-instagram"></i></a>'
                                      ,'<a href="https://twitter.com/dantheftotto/" target="_blank>"','<i class="fab fa-twitter"></i></a>'
                                      ,'<a href="https://github.com/dlotto" target="_blank>"','<i class="fab fa-github"></i></a>'
                                      ,'</span>\');
    })
    '))),
                        # Stayin' Alive! ----
